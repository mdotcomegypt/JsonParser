...
public class SuperFixturesAdapter extends RecyclerView.Adapter<SuperFixturesAdapter.ViewHolder> {
    ...
    public SuperFixturesAdapter(ArrayList<HashMap<String, String>> ScheduleList) {
    ...
    @Override
    public SuperFixturesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
