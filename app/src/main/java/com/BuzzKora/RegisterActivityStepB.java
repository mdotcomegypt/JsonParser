...
public class RegisterActivityStepB extends AppCompatActivity {
    ...
    String BASE_URL = "http://90kora.com/fav-list.php?key=";
    String URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Titles = getResources().getStringArray(R.array.register_title);
        Keys = getResources().getStringArray(R.array.register_key);
        Shorts = getResources().getStringArray(R.array.register_short);
        ...
        if (size == 0) {
            ...
            TargetTitles = new String[1];
            TargetShorts = new String[1];


            TargetTitles[0] = getResources().getString(R.string.super_teams);
            TargetShorts[0] = "SUPER";
            ...
            TargetTitles = new String[size];
            TargetShorts = new String[size];

            int x= 0;
            for (int i = 0; i < Titles.length; i++){
                String key = "key_" + Keys[i];
                if(SP.getBoolean(key, false)) {
                    TargetTitles[x] = Titles[i];
                    TargetShorts[x] = Shorts[i];
                    x = x + 1;
                }
        ...
        adapter = new FavoritTitlesAdapter(TargetTitles);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), RegisterActivityStepC.class);
                finish();
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(mContext, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        URL = BASE_URL + TargetShorts[position];
    ...
    protected void onResume() {
        super.onResume();
        AnalyticsApp.getInstance().trackScreenView("Register Step B");
    }
