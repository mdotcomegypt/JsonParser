...
import static com.BuzzKora.LeagueActivity.leagueNews;
...
public class LeagueNewsFragment extends Fragment {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < jsonData.length(); i++) {
                    ...
                    HashMap<String, String> MoreNews = new HashMap<String, String>();
                    ...
                    MoreNews.put(NEWS_KEY_DATE, row.getString("date"));
    ...
    public void onResume() {
        ...
        AnalyticsApp.getInstance().trackScreenView("League News Screen");
    }
